                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        <label for="namaLengkap">
                            Nomor RT<span class="required">*</span>
                        </label>
                        <input
                            type="text"
                            id="nomor_rt"
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('nama_rt', $rt->nama_rt) }}"
                            required
                        >
                        <div class="error-message">Nama lengkap wajib diisi</div>
                    </div>
                    <div class="upload-section">
                        <div class="upload-label">Upload Geojson<span class="required">*</span></div>

                        <div class="upload-group" id="ktpGroup">
                            <div class="upload-input" id="ktpFileName">Map Polygon Geojson (geojson - Maks 2MB)</div>
