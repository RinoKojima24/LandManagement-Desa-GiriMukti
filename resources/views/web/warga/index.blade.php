    ...
    <div class="bg-white shadow-sm sticky top-0 z-10">
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-xl font-semibold text-gray-900">Data Warga</h1>
            </div>
        </div>
    </div>
            ...
            <form method="GET" action="{{ url()->current() }}" id="filterForm">
                ...
                <div class="mb-4">
                    <div class="relative row">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <select name="status" id="status" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <select name="role" id="role" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
