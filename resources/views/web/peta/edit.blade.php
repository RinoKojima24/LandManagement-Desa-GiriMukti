    ...
    <div class="mb-4">
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center mb-3">
                ...
                <h5 class="mb-0 fw-bold">Edit Data Peta Tanah</h5>
            </div>
            <div>
            <form action="{{ url('tanah/'.$peta->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger" onclick="return confirm('Yakin ingin menyimpan data?')">
                    Hapus Data
                </button>
            </form>
            </div>
