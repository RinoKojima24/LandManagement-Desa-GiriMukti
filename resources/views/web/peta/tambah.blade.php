        ...
        <form action="{{ url('tanah') }}" method="POST" class="mb-3" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    {{-- <input type="text" name="titik_kordinat_lat" placeholder="Titik Kordinat (latitude)" class="form-control" id="titik_kordinat_lat"> --}}
                </div>
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <input type="text" name="titik_kordinat_2" value="{{ old('titik_kordinat_2') }}" placeholder="Titik Kordinat 2 (-0.4743788971644572, 117.15811604595541)" class="form-control" id="titik_kordinat_2">
                </div>
                <div class="form-group col-sm-12 col-md-6">
                    <label for="">Titik Kordinat 3<span class="required">*</span></label>
                    <input type="text" name="titik_kordinat_3" value="{{ old('titik_kordinat_3') }}" placeholder="Titik Kordinat 3 (-0.4743788971644572, 117.15811604595541)" class="form-control" id="titik_kordinat_3">
                </div>
                <div class="form-group col-sm-12 col-md-6">
                    <label for="">Titik Kordinat 4<span class="required">*</span></label>
                    <input type="text" name="titik_kordinat_4" value="{{ old('titik_kordinat_4') }}" placeholder="Titik Kordinat 4 (-0.4743788971644572, 117.15811604595541)" class="form-control" id="titik_kordinat_4">
                </div> --}}
